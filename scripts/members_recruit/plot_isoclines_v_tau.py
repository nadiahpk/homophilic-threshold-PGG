...
legend2 = plt.legend([l[0] for l in plot_lines], [r'$\tau=' + str(spar['tau']) + r'$' for spar in specific_pars], loc='center right')
...
plt.tight_layout()
plt.savefig('../../results/members_recruit/isoclines_v_tau.pdf')
plt.close()
