...
legend2 = plt.legend([l[0] for l in plot_lines], [r'$n=' + str(spar['n']) + r'$' for spar in specific_pars], loc='center left')
...
plt.tight_layout()
plt.savefig('../../results/leader_recruitor_nonkin_probability/isoclines_v_n.pdf')
plt.close()
