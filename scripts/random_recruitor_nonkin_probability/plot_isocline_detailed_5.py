...
make_arrow(q_0/2,         0.55, -0.1)
make_arrow((q_0+q_1)/2,   0.60, -0.1)
make_arrow((q_0+q_1)/2,   0.00, +0.07)
make_arrow((q_1+q_max)/2, 0.62, -0.1)
make_arrow((q_1+q_max)/2, 0.10, +0.1)
make_arrow((q_1+q_max)/2, 0.85, +0.1)
make_arrow((q_max+1)/2,   0.45, +0.1)
